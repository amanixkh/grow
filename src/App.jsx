...
function Logo() {
  return (
    <span className="inline-flex items-center gap-[9px] text-[#f6e9c8]">
      ...
      >
        <path
          d="M13 26C13 26 13 15 13 10C13 6 9 3 3 3C3 9 7 12.5 13 13"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
        ...
        <path
          d="M13 13C19 12.5 23 9 23 3C17 3 13 6 13 10"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
        ...
        <path
          d="M13 26C13 26 13 17 13 13C13 9 16 6 21 6"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinecap="round"
          opacity="0.55"
        ...
        <path
          d="M13 26C13 26 13 17 13 13C13 9 10 6 5 6"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinecap="round"
          opacity="0.55"
      ...
      <span className="text-base font-semibold tracking-[.14em]">
        Nakheel
      </span>
    </span>
  )
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Birds */}
      <div
        className="pointer-events-none absolute inset-0 z-[1] text-[#f6e9c8]"
        aria-hidden="true"
      >
      ...
      {/* Navigation */}
      <header className="relative z-[2] flex justify-between px-[5vw] py-7 max-[700px]:px-[7vw] max-[700px]:py-[22px]">
        <Logo />
      </header>
        ...
        >
          ...
          <button
            ...
            className={`
              ...
              rounded-full
              border
              border-[rgba(240,204,131,0.75)]
              py-[10px]
              pl-[19px]
              pr-[11px]
              text-[#f7e9c5]
              shadow-[0_10px_24px_rgba(10,29,21,0.24),inset_0_1px_rgba(255,255,255,0.12)]
              transition-all
              duration-[350ms]
              ease-in-out
              hover:-translate-y-[3px]
              hover:bg-[#285744]
              hover:shadow-[0_15px_28px_rgba(10,29,21,0.3),inset_0_1px_rgba(255,255,255,0.18)]
              focus-visible:outline
              focus-visible:outline-2
              focus-visible:outline-offset-[5px]
              focus-visible:outline-[#f6e9c8]
              motion-reduce:transition-none
              max-[700px]:min-w-[172px]
              max-[700px]:py-[14px]
              max-[700px]:pl-[18px]
              max-[700px]:pr-[14px]
              ${started ? 'bg-[#f2ca82]' : 'bg-[rgba(25,55,45,0.72)]'}
            `}
          >
            ...
            <span
              className="grid h-8 w-8 place-items-center rounded-full bg-[#f0cc83] text-[20px] text-[#203d32]"
              style={{
